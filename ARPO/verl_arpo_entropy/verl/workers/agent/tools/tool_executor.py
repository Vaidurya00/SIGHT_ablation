...
class ToolExecutor:
    ...
    def extract_content(text: str, tag: str) -> str:
        ...
        Returns:
            The extracted content, or an empty string if not found or if placeholder detected.
        """
        try:
            start_tag = f"<{tag}>"
            end_tag = f"</{tag}>"
            ...
            placeholder_patterns = [
                ...
                "search result here",
                "python code here",
                "python interpreter result here"
            ]
            content_lower = content.lower()
            for pattern in placeholder_patterns:
                if pattern in content_lower:
                    logger.warning(f"Placeholder detected in {tag} tag: '{content}'. Returning empty string.")
                    return ""
